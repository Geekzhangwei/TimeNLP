...
# 时间语句分析
class TimeUnit:
    # exp_time: (exp_time, (start, end))
    def __init__(self, exp_time, normalizer, contextTp):
        self.exp_time = exp_time[0]
        self.start_index = exp_time[1][0]
        self.end_index = exp_time[1][1]
    ...
    def checkContextTime(self, checkTimeIndex):
        ...
        if self.isFirstTimeSolveContext and checkTimeIndex == 3 and self.tp_origin.tunit[checkTimeIndex] >= 12 and \
